...
446a:  0e12           push	r14 ; push pointer to password
446c:  0f12           push	r15 ; push pointer to username
446e:  3012 7d00      push	#0x7d ; push interrupt to call
...
4586:  b012 b846      call	#0x46b8 <getsn> ; input username to 0x2402
...
45a0:  3b80 0224      sub	#0x2402, r11 ; count of chars in username
45a4:  3e40 0224      mov	#0x2402, r14
45a8:  0f41           mov	sp, r15
45aa:  b012 f446      call	#0x46f4 <strcpy> ; copy username to stack pointer
45ae:  7b90 2100      cmp.b	#0x21, r11
45b2:  0628           jnc	#0x45c0 <login+0x60> ; if len username < 33 then input password
...
45d6:  b012 b846      call	#0x46b8 <getsn> ; input password to 0x2402
...
45ea:  b012 f446      call	#0x46f4 <strcpy> ; copy password to stack pointer
45ee:  3f40 0124      mov	#0x2401, r15
45f2:  1f53           inc	r15
45f4:  cf93 0000      tst.b	0x0(r15)
45f8:  fc23           jnz	#0x45f2 <login+0x92>
45fa:  3f80 0224      sub	#0x2402, r15 ; count of chars in password
45fe:  0f5b           add	r11, r15     ; combined count of chars in username + password
4600:  7f90 2100      cmp.b	#0x21, r15
4604:  0628           jnc	#0x4612 <login+0xb2> ; if len username + len password < 33 then test
4606:  1f42 0024      mov	&0x2400, r15
460a:  b012 c846      call	#0x46c8 <puts>
460e:  3040 4244      br	#0x4442 <__stop_progExec__> ; else halt
4612:  0f41           mov	sp, r15                     ; reset r15 to beginning of username and password
