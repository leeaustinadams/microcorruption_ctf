...
4504:  3b41           pop	r11
4506:  3041           ret
4508 <free>                                     ; r15 is the pointer to memory to free
4508:  0b12           push	r11
450a:  3f50 faff      add	#0xfffa, r15        ; subtract 6 from r15, now pointing at block header
450e:  1d4f 0400      mov	0x4(r15), r13       ; r13 is current size/used bit
4512:  3df0 feff      and	#0xfffe, r13        ; clear current used bit
4516:  8f4d 0400      mov	r13, 0x4(r15)       ; store current size/used bit
451a:  2e4f           mov	@r15, r14           ; r14 = prev
451c:  1c4e 0400      mov	0x4(r14), r12       ; r12 = prev size/used bit
        ;; if (prev->free) {
4520:  1cb3           bit	#0x1, r12           ; if prev unused, coelesce
4522:  0d20           jnz	#0x453e <free+0x36>
4524:  3c50 0600      add	#0x6, r12           ; add the 6 bytes of block header
4528:  0c5d           add	r13, r12            ; size of this combined block
452a:  8e4c 0400      mov	r12, 0x4(r14)       ; store coelesced size
452e:  9e4f 0200 0200 mov	0x2(r15), 0x2(r14)  ; prev->next = next
4534:  1d4f 0200      mov	0x2(r15), r13       ; r13 = next
4538:  8d4e 0000      mov	r14, 0x0(r13)       ; next->prev = prev
453c:  2f4f           mov	@r15, r15           ; r15 = prev
        ;; }
453e:  1e4f 0200      mov	0x2(r15), r14       ; r14 = next
4542:  1d4e 0400      mov	0x4(r14), r13       ; r13 contains size/used bit of next
        ;; if (next->free) {
4546:  1db3           bit	#0x1, r13
4548:  0b20           jnz	#0x4560 <free+0x58> ; if LSB is zero, unlink/coelesce
454a:  1d5f 0400      add	0x4(r15), r13       ; r13 contains combined size
454e:  3d50 0600      add	#0x6, r13           ; add the 6 bytes of block header
4552:  8f4d 0400      mov	r13, 0x4(r15)       ; store size/used bit
4556:  9f4e 0200 0200 mov	0x2(r14), 0x2(r15)  ; prev->next = next
455c:  8e4f 0000      mov	r15, 0x0(r14)       ; next->prev = prev
        ;; }
4560:  3b41           pop	r11
4562:  3041           ret
4564 <unlock_door>
...
456c:  2153           incd	sp
456e:  3041           ret
4570 <test_password_valid>      ; r15 points at password
4570:  0412           push	r4
4572:  0441           mov	sp, r4
4574:  2453           incd	r4
4576:  2183           decd	sp
...
4642:  b012 6444      call	#0x4464 <malloc> ; allocate 16 bytes for username
4646:  0a4f           mov	r15, r10         ; r10 points at username buffer
4648:  3f40 1000      mov	#0x10, r15
464c:  b012 6444      call	#0x4464 <malloc> ; allocate 16 bytes for password
4650:  0b4f           mov	r15, r11         ; r11 points at password buffer
4652:  3f40 9a45      mov	#0x459a, r15
4656:  b012 1a47      call	#0x471a <puts>
465a:  3f40 c845      mov	#0x45c8, r15
465e:  b012 1a47      call	#0x471a <puts>
4662:  3e40 3000      mov	#0x30, r14      ; param 2, max length (48 bytes)
4666:  0f4a           mov	r10, r15        ; param 1, buffer
4668:  b012 0a47      call	#0x470a <getsn> ; read username
466c:  3f40 c845      mov	#0x45c8, r15
4670:  b012 1a47      call	#0x471a <puts>
4674:  3f40 d445      mov	#0x45d4, r15
4678:  b012 1a47      call	#0x471a <puts>
467c:  3e40 3000      mov	#0x30, r14      ; param 2, max length (48 bytes)
4680:  0f4b           mov	r11, r15        ; param 1, buffer
4682:  b012 0a47      call	#0x470a <getsn> ; read password
