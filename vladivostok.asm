...
443e:  3bf0 fe7f      and	#0x7ffe, r11 ; mask off top (sign?) bit, 2 byte align
4442:  3b50 0060      add	#0x6000, r11 ; offset by 0x6000
...
4460:  3ff0 fe0f      and	#0xffe, r15 ; mask off top byte, 2 byte align
4464:  0e4b           mov	r11, r14
4466:  0e8f           sub	r15, r14
4468:  3e50 00ff      add	#0xff00, r14
446c:  0d4b           mov	r11, r13
446e:  3d50 5c03      add	#0x35c, r13
4472:  014e           mov	r14, sp ; set the stack pointer to random address
4474:  0f4b           mov	r11, r15
4476:  8d12           call	r13 ; call wherever the code got relocated to
...
448a:  3c50 6a03      add	#0x36a, r12 ; save the address of printf in r12
...
4540:  0012           push	pc
4542:  0212           push	sr
4544:  0f4b           mov	r11, r15 ; interrupt 0 putchar
4546:  8f10           swpb	r15
...
4576:  b012 1000      call	#0x10 ; putchar('\n')
457a:  3241           pop	sr
...
4588:  0012           push	pc
458a:  0212           push	sr
458c:  0f4e           mov	r14, r15 ; interrupt 0, putchar
458e:  8f10           swpb	r15
...
45a4:  0012           push	pc
45a6:  0212           push	sr
45a8:  0f4e           mov	r14, r15 ; interrupt 0, putchar
45aa:  8f10           swpb	r15
...
45c2:  0a12           push	r10 ; arg 1, read 8 bytes
45c4:  0b12           push	r11 ; arg 0, read to 0x2426
45c6:  0d12           push	r13
45c8:  0012           push	pc
45ca:  0212           push	sr
45cc:  0f4d           mov	r13, r15 ; interrupt 2, gets
45ce:  8f10           swpb	r15
45d0:  024f           mov	r15, sr
45d2:  32d0 0080      bis	#0x8000, sr
45d6:  b012 1000      call	#0x10 ; gets(0x2426, 8);
45da:  3241           pop	sr
...
463c:  0c43           clr	r12                        ; r12 is the interrupt to call, 0 is putchar
463e:  103c           jmp	#0x4660 <_aslr_main+0x1de> ; while(*r14 != 0) {
4640:  1e53           inc	r14                        ; r14++
4642:  8d11           sxt	r13
4644:  0c12           push	r12 ; 0
4646:  0d12           push	r13 ;
4648:  0c12           push	r12 ; 0
464a:  0012           push	pc
464c:  0212           push	sr
...
4658:  b012 1000      call	#0x10 ; putchar
465c:  3241           pop	sr
465e:  3152           add	#0x8, sp
4660:  6d4e           mov.b	@r14, r13 ; r13 = char to print
4662:  4d93           tst.b	r13       ; check for 0 to end loop
...
4680:  b012 1000      call	#0x10 ; putchar '\n'
4684:  3241           pop	sr
...
4692:  0c12           push	r12 ; arg 1, read 20 bytes
4694:  0b12           push	r11 ; arg 0, read to sp + 4
4696:  0d12           push	r13
4698:  0012           push	pc
469a:  0212           push	sr
469c:  0f4d           mov	r13, r15 ; interrupt 2, gets
469e:  8f10           swpb	r15
46a0:  024f           mov	r15, sr
46a2:  32d0 0080      bis	#0x8000, sr
46a6:  b012 1000      call	#0x10 ; gets(sp + 4, 20)
46aa:  3241           pop	sr
46ac:  3152           add	#0x8, sp
46ae:  3d50 7c00      add	#0x7c, r13 ; interrupt 0x7c?
...
46c8:  b012 1000      call	#0x10 ; interrupt 0x7c?
46cc:  3241           pop	sr
...
4702:  103c           jmp	#0x4724 <_aslr_main+0x2a2> ; while(*r13 !+ 0) {
4704:  1d53           inc	r13
4706:  8c11           sxt	r12
4708:  0e12           push	r14
470a:  0c12           push	r12
...
471c:  b012 1000      call	#0x10 ; putchar
4720:  3241           pop	sr
4722:  3152           add	#0x8, sp
4724:  6c4d           mov.b	@r13, r12
4726:  4c93           tst.b	r12 ; end loop if *r13 is 0
...
4744:  b012 1000      call	#0x10 ; putchar('\n')
4748:  3241           pop	sr
...
4a52:  0012           push	pc
4a54:  0212           push	sr
4a56:  0f4d           mov	r13, r15 ; interrupt type is passed in the high byte of sr
4a58:  8f10           swpb	r15
4a5a:  024f           mov	r15, sr
4a5c:  32d0 0080      bis	#0x8000, sr
4a60:  b012 1000      call	#0x10 ; interrupt 0x7e
4a64:  3241           pop	sr
