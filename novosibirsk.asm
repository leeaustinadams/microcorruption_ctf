...
45d8:  2183           decd	sp
45da:  1b44 0200      mov	0x2(r4), r11 ; r11 is the format string
45de:  8441 f2ff      mov	sp, -0xe(r4)
45e2:  0f4b           mov	r11, r15
45e4:  0e43           clr	r14
45e6:  0b3c           jmp	#0x45fe <printf+0x38> ;
45e8:  1f53           inc	r15                   ; r15 to the next char
45ea:  7d90 2500      cmp.b	#0x25, r13            ; look for % character
45ee:  0720           jne	#0x45fe <printf+0x38>
45f0:  6d9f           cmp.b	@r15, r13             ; look for %%
45f2:  0320           jne	#0x45fa <printf+0x34> ; if not, it's a format specifier
45f4:  1f53           inc	r15                   ; r15 to the next char
45f6:  0d43           clr	r13
45f8:  013c           jmp	#0x45fc <printf+0x36>
45fa:  1d43           mov	#0x1, r13
45fc:  0e5d           add	r13, r14  ; increment r14 by 1
45fe:  6d4f           mov.b	@r15, r13 ; load next format string char to r13
4600:  4d93           tst.b	r13
4602:  f223           jnz	#0x45e8 <printf+0x22> ; check for termination of string
4604:  0f4e           mov	r14, r15              ; r14 is the number of format specifiers found
4606:  0f5f           add	r15, r15              ; r15 is now the number of bytes of the source values/pointers
4608:  2f53           incd	r15                   ; add space for one more pointer
460a:  018f           sub	r15, sp               ; move stack pointer back to parameters
460c:  0941           mov	sp, r9
460e:  0c44           mov	r4, r12
4610:  2c52           add	#0x4, r12
4612:  0f41           mov	sp, r15 ; r15 points at first source of format specifier
4614:  0d43           clr	r13 ; for each format specifier found for(r13 = 0; r13 < r14; r13++)
4616:  053c           jmp	#0x4622 <printf+0x5c>
4618:  af4c 0000      mov	@r12, 0x0(r15)
461c:  1d53           inc	r13 ; r13++
461e:  2f53           incd	r15 ; r15 points at next source
4620:  2c53           incd	r12
4622:  0d9e           cmp	r14, r13
4624:  f93b           jl	#0x4618 <printf+0x52> ; loop if r13 < r14
4626:  0a43           clr	r10
...
4656:  7e90 7300      cmp.b	#0x73, r14 ; if(r14 == 's')
465a:  0b20           jne	#0x4672 <printf+0xac>
465c:  2b49           mov	@r9, r11 ; point r11 at source string
465e:  053c           jmp	#0x466a <printf+0xa4>
4660:  1a53           inc	r10 ; print contents of string pointed to until null byte
4662:  1b53           inc	r11
4664:  8f11           sxt	r15
4666:  b012 4e45      call	#0x454e <putchar>
466a:  6f4b           mov.b	@r11, r15
466c:  4f93           tst.b	r15
466e:  f823           jnz	#0x4660 <printf+0x9a> ; loop
4670:  253c           jmp	#0x46bc <printf+0xf6>
4672:  7e90 7800      cmp.b	#0x78, r14 ; if(r14 == 'x')
...
46b0:  7e90 6e00      cmp.b	#0x6e, r14 ; if(r14 == 'n')
46b4:  0320           jne	#0x46bc <printf+0xf6>
46b6:  2f49           mov	@r9, r15
46b8:  8f4a 0000      mov	r10, 0x0(r15) ; store characters printed so far at r15
46bc:  2953           incd	r9            ; point r9 to next source parameter
