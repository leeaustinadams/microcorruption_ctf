...
4552:  0412           push	r4
4554:  0441           mov	sp, r4
4556:  2452           add	#0x4, r4         ; location of interrupt result?
4558:  3150 d8ff      add	#0xffd8, sp      ; subtract 40 from stack pointer (reserve 40 bytes)
455c:  c443 faff      mov.b	#0x0, -0x6(r4)   ; initialize something to 0
4560:  f442 e7ff      mov.b	#0x8, -0x19(r4)  ; initialize minimum password length to 8
4564:  f440 1000 e8ff mov.b	#0x10, -0x18(r4) ; initialize maximum password length to 16
...
45a0:  b012 5447      call	#0x4754 <strcpy> ; copy entered username from 0x2404 to (r4 - 42)
...
45cc:  b012 5447      call	#0x4754 <strcpy> ; copy entered password from 0x2404 to (r4 - 23)
45d0:  0f4b           mov	r11, r15
45d2:  0e44           mov	r4, r14
45d4:  3e50 e8ff      add	#0xffe8, r14 ; r14 points at password
45d8:  1e53           inc	r14          ; count chars in password
45da:  ce93 0000      tst.b	0x0(r14)     ; test for null terminator
45de:  fc23           jnz	#0x45d8 <login+0x88>
45e0:  0b4e           mov	r14, r11
45e2:  0b8f           sub	r15, r11 ; r14 - r15 yields character count
45e4:  5f44 e8ff      mov.b	-0x18(r4), r15 ; minimum is held 24 bytes before r4
45e8:  8f11           sxt	r15
45ea:  0b9f           cmp	r15, r11
45ec:  0628           jnc	#0x45fa <login+0xaa>
45ee:  1f42 0024      mov	&0x2400, r15
45f2:  b012 2847      call	#0x4728 <puts> ; error password too short
45f6:  3040 4044      br	#0x4440 <__stop_progExec__>
45fa:  5f44 e7ff      mov.b	-0x19(r4), r15 ; maximum is held 25 bytes before r4
45fe:  8f11           sxt	r15
4600:  0b9f           cmp	r15, r11
4602:  062c           jc	#0x4610 <login+0xc0>
4604:  1f42 0224      mov	&0x2402, r15
4608:  b012 2847      call	#0x4728 <puts> ; error password too long
460c:  3040 4044      br	#0x4440 <__stop_progExec__>
4610:  c443 d4ff      mov.b	#0x0, -0x2c(r4) ; initialize result to 0, 44 bytes before r4
4614:  3f40 d4ff      mov	#0xffd4, r15
4618:  0f54           add	r4, r15 ; subtract 44 from r15
461a:  0f12           push	r15
...
4634:  c493 d4ff      tst.b	-0x2c(r4) ; check result of interrupt
...
4650:  0624           jz	#0x465e <login+0x10e> ; if r4 - 6 is zero, return instead of halt?
4652:  1f42 0024      mov	&0x2400, r15
4656:  b012 2847      call	#0x4728 <puts>
465a:  3040 4044      br	#0x4440 <__stop_progExec__>
465e:  3150 2800      add	#0x28, sp ; pop stack pointer back to where it was, 40 bytes
4662:  3441           pop	r4
4664:  3b41           pop	r11
4666:  3041           ret
4668 <__do_nothing>
